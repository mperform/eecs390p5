...
UC_FUNCTION(println)(UC_FUNCTION(long_to_string)(  uc_id(UC_VAR(f))
)); //Statement
UC_FUNCTION(println)(UC_FUNCTION(long_to_string)(  uc_id(UC_VAR(b))
)); //Statement
UC_FUNCTION(println)(UC_FUNCTION(long_to_string)(  uc_id(UC_VAR(z))
)); //Statement
(UC_VAR(x) = UC_VAR(z)); //Statement
UC_FUNCTION(println)(UC_FUNCTION(long_to_string)(  uc_id(UC_VAR(x))
)); //Statement
}
} // namespace uc
